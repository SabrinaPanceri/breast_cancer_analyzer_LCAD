...
def crop_cancer(pathList, roiPathList, labelList, root, folder, sobrepos):
    ...
    while j < len(pathList):
        ...
        filename = pathList[j].split('_dataset/Calc-Train/')
        # print(filename)
        ...
        if (j+1) < len(pathList):
            nextFile = roiPathList[j+1].split('_dataset/Calc-Train/')
...
def main(args):
    ...
    # e = '/home/wintermute/breast_cancer_analyzer_LCAD/dataset/Calc-Test-CC.txt'
    # r = '/home/wintermute/breast_cancer_analyzer_LCAD/dataset/Calc-Test-CC-ROI.txt'
