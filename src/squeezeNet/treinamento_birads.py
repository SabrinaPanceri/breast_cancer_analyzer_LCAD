...
RUNS_FOLDER = '/mnt/dadosSabrina/breast_cancer_analyzer_LCAD/src/squeezeNet/runs_birads'
...
TRAINING = (
        '/mnt/dadosSabrina/breast_cancer_analyzer_LCAD/src/squeezeNet/aux_files/cbisddsm_train_BIRADS_OF_100.txt',
)

TRAINING_DIR = (
        #'',
         '/mnt/dadosSabrina/breast_cancer_analyzer_LCAD/dataset/birads_dataset',
)
