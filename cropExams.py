    ...
    if cropCancerBool == 0:
        if distanceBetweenSmallestAndBiggestWhitePixelInCoordinateX <= 256 and distanceBetweenSmallestAndBiggestWhitePixelInCoordinateY <= 256:
            if temporaryBiggestWhitePixelOfCoordinateX > biggestBlackPixelAtCoordinateX:
                row = [croppedImagesPath + str(j) + str(patientFile[j]) + 'NoCancer.png', '0']                
                with open('Calc_Case_Cancer_CC_NC_Cropped_Images.csv', 'a') as csvCrops:    
                    writer = csv.writer(csvCrops)
                    writer.writerow(row)
                csvCrops.close()
                cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + 'NoCancer.png'), examImage[(temporarySmallestWhitePixelOfCoordinateY - 512):(temporarySmallestWhitePixelOfCoordinateY - 256), (biggestWhitePixelOfCoordinateX - 256):biggestWhitePixelOfCoordinateX])
                ...
                if biggestWhitePixelOfCoordinateX - 256 < smallestBlackPixelAtCoordinateX: 
                    cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + 'NoCancer.png'), examImage[(temporarySmallestWhitePixelOfCoordinateY - 512):(temporarySmallestWhitePixelOfCoordinateY - 256), 0:256])
                else:    
                    cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + 'NoCancer.png'), examImage[(temporarySmallestWhitePixelOfCoordinateY - 512):(temporarySmallestWhitePixelOfCoordinateY - 256), (biggestWhitePixelOfCoordinateX - 256):biggestWhitePixelOfCoordinateX])
        ...
        if distanceBetweenSmallestAndBiggestWhitePixelInCoordinateX <= 256 and distanceBetweenSmallestAndBiggestWhitePixelInCoordinateY <= 256:
            if temporaryBiggestWhitePixelOfCoordinateX > biggestBlackPixelAtCoordinateX:
                row = [croppedImagesPath + str(j) + str(patientFile[j]) + '.png', '1']                
                with open('Calc_Case_Cancer_CC_Cropped_Images.csv', 'a') as csvCrops:    
                    writer = csv.writer(csvCrops)
                    writer.writerow(row)
                csvCrops.close()
                cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + '.png'), examImage[temporarySmallestWhitePixelOfCoordinateY:(temporarySmallestWhitePixelOfCoordinateY + 256), (biggestWhitePixelOfCoordinateX - 256):biggestWhitePixelOfCoordinateX])    
                ...
                if biggestWhitePixelOfCoordinateX - 256 < smallestBlackPixelAtCoordinateX: 
                    cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + '.png'), examImage[temporarySmallestWhitePixelOfCoordinateY:(temporarySmallestWhitePixelOfCoordinateY + 256), 0:256])   
                else:    
                    cv2.imwrite(os.path.join(croppedImagesPath + str(j) + str(patientFile[j]) + '.png'), examImage[temporarySmallestWhitePixelOfCoordinateY:(temporarySmallestWhitePixelOfCoordinateY + 256), (biggestWhitePixelOfCoordinateX - 256):biggestWhitePixelOfCoordinateX])    
