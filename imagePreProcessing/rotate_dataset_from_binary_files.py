...
def calculate_mean_and_std(mean_max, mean_mean, mean_min, mean_numb, mean_std, num_rotations,
					 sum_var_max, sum_var_mean, sum_var_min, sum_var_numb, sum_var_std, total_elements, num_files):
	
	arq = open(out_path + 'dataset_mean_std.txt', 'a')
	
	total_mean_max = mean_max  / num_files
	total_mean_mean= mean_mean / num_files
	total_mean_min = mean_min  / num_files
	total_mean_numb= mean_numb / num_files
	total_mean_std = mean_std  / num_files
...
for item in dataset_list:
	...
	sum_var_max, sum_var_mean, sum_var_min, sum_var_numb, sum_var_std = calc_variance(new_data, new_size)
	var_max  +=  sum_var_max 
